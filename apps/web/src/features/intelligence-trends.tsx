...
export function TrendsExplorer({ data, month }: {
  ...
  {data.trend.length === 1 && <p className="notice history-developing">One observed month: current composition is available above. Trend lines develop as more periods are imported; missing periods are not zero.</p>}
