...
export function Relationships({ compact = false, selectedMonth, selectedCurrency }: {
    ...
    const c = data?.currencies.find(c => c.currency === (selectedCurrency ?? period.currency)) ?? data?.currencies[0];
    if (compact)
