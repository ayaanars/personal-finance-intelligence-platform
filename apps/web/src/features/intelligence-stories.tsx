...
export function InsightFeed({ data, compact = false }: {
  ...
  {!insights.length && <p className="notice history-developing">{data.comparison.state === 'available' ? 'No supported month-over-month change to highlight.' : 'History-based changes need two adjacent months. Current-period spending and composition are available now.'}</p>}
 </div>;
}
